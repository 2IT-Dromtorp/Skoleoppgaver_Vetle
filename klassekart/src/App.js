  ...
  return (
    <div className="App">
      <header className="App-header">
        <div className="seterad" id="bottom_right">
          
        </div>
        <div className="seterad" id="middle_right">

        </div>
        <div className="seterad" id="top_right">

        </div>
        <div className="seterad" id="bottom_left">

        </div>
        <div className="seterad" id="middle_left">

        </div>
        <div className="seterad" id="top_left">
